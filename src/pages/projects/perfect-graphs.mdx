...
After collecting and organizing a set of concepts and fun facts surrounding perfect graphs, we determined the structure of the video with a storyboard. We were then able to create the following video (note that some background in graph theory is assumed):
